...
import { Send, User, Users, Search, ArrowLeft } from 'lucide-react';
...
export default function ChatPage() {
  ...
  return (
    <div className="h-[calc(100vh-10rem)] flex">
      ...
      <div className={cn("w-full md:w-1/3 md:min-w-[300px] flex-col md:flex", selectedUser ? 'hidden' : 'flex')}>
      ...
      <div className={cn("flex-1 flex-col", selectedUser ? 'flex' : 'hidden md:flex')}>
        {selectedUser ? (
          <Card className="flex-1 flex flex-col md:ml-4">
          ...
          <div className="flex-1 flex items-center justify-center text-muted-foreground md:ml-4 border rounded-lg">
